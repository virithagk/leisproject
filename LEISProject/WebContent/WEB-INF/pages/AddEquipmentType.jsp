...
<center>
		...
		<form:form method="POST" action="/LEISProject/saveEquipmentType.html">
	   		<table>
			    <tr>
			        <td><form:label path="typeCode">Equipment Type Code:</form:label></td>
			        <td><form:input path="typeCode" readonly="false"/></td>
			    </tr>
			    <tr>
			        <td><form:label path="typeName">Equipment Type Name:</form:label></td>
			        <td><form:input path="typeName" value="${equipmentType.typeName}"/></td>
			    </tr>
		...
		<br/>
  <c:if test="${!empty equipmentTypes}">
	<table align="center" border="1">
		...
		<c:forEach items="${equipmentTypes}" var="equipmentType">
			<tr>
				<td><c:out value="${equipmentType.typeCode}"/></td>
				<td><c:out value="${equipmentType.typeName}"/></td>
				<td align="center"><a href="editEquipmentType.html?typeCode=${equipmentType.typeCode}">Edit</a> | <a href="deleteEquipmentType.html?typeCode=${equipmentType.typeCode}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
