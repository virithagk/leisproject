...
function btn_actions(paramvalue) {
alert("inside the funsdfgsdf part");
	if(paramvalue=='add') {
		alert("inside the add");
	document.getElementById("manufactureForm").action="addManufacturer";
	document.getElementById("manufactureForm").submit();
	} else if(paramvalue=="update") {
		alert("inside the update");
	document.getElementById("manufactureForm").action="/updateManufacturer";
	} else if(paramvalue=="remove") {
	document.getElementById("manufactureForm").action="/removeManufacturer";
...
<div>	
	...
	<form id="manufactureForm" method="get">
		
		<input type="button" value="Add" onClick="javascript: btn_actions('add')"/>
