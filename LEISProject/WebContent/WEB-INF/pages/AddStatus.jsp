...
<center>
		...
		<form:form method="POST" action="/LEISProject/saveStatus.html">
	   		<table>
			    <tr>
			        <td><form:label path="statusCode">Status Code:</form:label></td>
			        <td><form:input path="statusCode" value="${status.statusCode}"/></td>
			    </tr>
			    <tr>
			        <td><form:label path="statusName">Status Name:</form:label></td>
			        <td><form:input path="statusName" value="${status.statusName}"/></td>
			    </tr>
...
<tbody>
		<c:forEach items="${statuses}" var="status">
			<tr>
				<td><c:out value="${status.statusCode}"/></td>
				<td><c:out value="${status.statusName}"/></td>
				<td align="center"><a href="editStatus.html?statusCode=${status.statusCode}">Edit</a> | <a href="deleteStatus.html?statusCode=${status.statusCode}">Delete</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
