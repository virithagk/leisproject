				...
				<div>
					<center>
						...
						<form:form method="POST"
							action="/LEISProject/saveManufacturer.html">
							<table>
								<tr>
									<td><form:label path="manufacturerName">Manufacturer Name:</form:label></td>
									<td><form:input path="manufacturerName"
											value="${manufacturer.manufacturerName}" /></td>
								</tr>
									...
									<tbody>
										<c:forEach items="${manufacturers}" var="manufacturer">
											...
											<tr>
												...
												<td align="center"><a
													href="editManufacturer.html?manufacturerId=${manufacturer.manufacturerId}">Edit</a>
													| <a
													href="deleteManufacturer.html?manufacturerId=${manufacturer.manufacturerId}">Delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
